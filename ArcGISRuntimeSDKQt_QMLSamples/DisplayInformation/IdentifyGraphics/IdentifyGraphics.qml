...
Rectangle {
    ...
    Component.onCompleted: {
        ...
        const polygonBuilder = ArcGISRuntimeEnvironment.createObject("PolygonBuilder", {spatialReference: ArcGISRuntimeEnvironment.createObject("SpatialReference", { wkid: 102100})});
