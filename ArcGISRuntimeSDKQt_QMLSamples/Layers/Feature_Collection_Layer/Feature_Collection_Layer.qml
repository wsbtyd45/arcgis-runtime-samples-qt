                ...
                FeatureCollection {
                    ...
                    FeatureCollectionTable {
                        ...
                        Component.onCompleted: {
                            ...
                            const point1 = ArcGISRuntimeEnvironment.createObject("Point", {x: -79.497238, y: 8.849289, spatialReference: ArcGISRuntimeEnvironment.createObject("SpatialReference", { wkid: 4326})});
                    ...
                    FeatureCollectionTable {
                        ...
                        Component.onCompleted: {
                            ...
                            const point1 = ArcGISRuntimeEnvironment.createObject("Point", {x: -79.497238, y: 8.849289, spatialReference: ArcGISRuntimeEnvironment.createObject("SpatialReference", { wkid: 4326})});
                            const point2 = ArcGISRuntimeEnvironment.createObject("Point", {x: -80.035568, y: 9.432302, spatialReference: ArcGISRuntimeEnvironment.createObject("SpatialReference", { wkid: 4326})});
                            const lineBuilder = ArcGISRuntimeEnvironment.createObject("PolylineBuilder", {spatialReference: ArcGISRuntimeEnvironment.createObject("SpatialReference", { wkid: 4326})});
                    ...
                    FeatureCollectionTable {
                        ...
                        Component.onCompleted: {
                            ...
                            const point1 = ArcGISRuntimeEnvironment.createObject("Point", {x: -79.497238, y: 8.849289, spatialReference: ArcGISRuntimeEnvironment.createObject("SpatialReference", { wkid: 4326})});
                            const point2 = ArcGISRuntimeEnvironment.createObject("Point", {x: -79.337936, y: 8.638903, spatialReference: ArcGISRuntimeEnvironment.createObject("SpatialReference", { wkid: 4326})});
                            const point3 = ArcGISRuntimeEnvironment.createObject("Point", {x: -79.11409, y: 8.895422, spatialReference: ArcGISRuntimeEnvironment.createObject("SpatialReference", { wkid: 4326})});
                            const polygonBuilder = ArcGISRuntimeEnvironment.createObject("PolygonBuilder", {spatialReference: ArcGISRuntimeEnvironment.createObject("SpatialReference", { wkid: 4326})});
