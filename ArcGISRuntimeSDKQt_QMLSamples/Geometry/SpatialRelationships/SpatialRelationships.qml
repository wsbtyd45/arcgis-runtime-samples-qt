        ...
        GraphicsOverlay {
            ...
            Graphic {
                ...
                Component.onCompleted: {
                    const polyBuilder = ArcGISRuntimeEnvironment.createObject("PolygonBuilder", {spatialReference: ArcGISRuntimeEnvironment.createObject("SpatialReference", { wkid: 102100})});
            ...
            Graphic {
                ...
                Component.onCompleted: {
                    const polyBuilder = ArcGISRuntimeEnvironment.createObject("PolylineBuilder", {spatialReference: ArcGISRuntimeEnvironment.createObject("SpatialReference", { wkid: 102100})});
